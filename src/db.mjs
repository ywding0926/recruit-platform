...
function scheduleToRow(x) {
  return {
    ...
    calendar_event_id: x.calendarEventId ?? null,
...
export async function saveData(d) {
  ...
  try {
    ...
    const results = await Promise.allSettled([
      ...
      upsertWithRetry(admin, "interview_schedules", shaped.interviewSchedules.map(scheduleToRow), ["id", "candidate_id", "round", "scheduled_at", "interviewers", "link", "location", "calendar_event_id", "created_at", "updated_at"]),
...
const TABLE_MAP = {
  ...
  interviewSchedules:  { sb: "interview_schedules",  toRow: scheduleToRow,  minKeys: ["id", "candidate_id", "round", "scheduled_at", "interviewers", "link", "location", "calendar_event_id", "created_at", "updated_at"] },
